...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/enstreamer: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/enstreamer ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/enstreamer.o: enstreamer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/enstreamer.o enstreamer.c

${OBJECTDIR}/iniparser.o: iniparser.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iniparser.o iniparser.c
